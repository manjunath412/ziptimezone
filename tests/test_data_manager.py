...
class TestDataManager(unittest.TestCase):
    ...
    def test_refresh_data_if_needed(
        self, mock_download, mock_exists, mock_rmtree, mock_makedirs
    ):
    ...
    def test_download_and_extract_zip_data(
        self, mock_remove, mock_get, mock_zip, mock_file
    ):
        ...
        # Run the function
        ziptimezone.data_manager.download_and_extract_zip_data(
            "http://example.com/data.zip", "/fake/dir"
        )
