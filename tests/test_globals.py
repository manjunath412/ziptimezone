...
class TestGlobals(unittest.TestCase):
    def setUp(self):
        self.mock_csv_data = "country_code\tpostal_code\tplace_name\tadmin_name1\tadmin_code1\tadmin_name2\tadmin_code2\tadmin_name3\tadmin_code3\tlatitude\tlongitude\taccuracy\n"\
    ...
    def test_load_zip_data_not_loaded(self, mock_dict_reader, mock_file):
        ...
        mock_dict_reader.return_value = iter([
            {'postal_code': '90210', 'latitude': '34.0901', 'longitude': '-118.4065'},
